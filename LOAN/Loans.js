...
const updateData = (emi) => {     
    ...
    props = {
        ...
        business: {
            name: "Trust Bank PLC.",
            address: "Shadhinata Tower, Bir Srestha Shaheed Jahangir Gate, Dhaka-1206.",
            phone: "16201 or 09611016201",
            email: "info@tblbd.com",
            email_1: "cards@tblbd.com",
        ...
        invoice: {
            ...
            invDesc: "The data shown on this report like interest rate, total loan amount are subjected to change. Please do not consider them as fixed.",
        },
        footer: {
